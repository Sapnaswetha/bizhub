(function ($) {
        ...
        $(document).on('click', '.tlp-single-item-popup' ,function (e) {
            ...
            var current,
                $this = $(this),
                $ids = $this.parents('.team-wrap').find(".tlp-team-item-count");
    ...
    function heightResize() {
        var maxH = 0;
        jQuery(".team .equal-height").height("auto");
        jQuery(".team .equal-height").each(function () {
        ...
        jQuery(".team .equal-height").css('height', maxH + "px");
    }